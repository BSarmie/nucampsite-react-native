    ...
    const renderCommentItem = ({item}) => {
        return (
            <View style={{margin: 10}}>
                ...
                <Rating readonly startingValue={item.rating} imageSize={10} stlye={{fontsize:'12', alignItems:'flex-start', paddingVertical:'5%'}} />
                ...
                >
                    <View style={styles.modal}>
                        ...
                        <Input 
                            ...
                            leftIconleftIconContainerStyle={{paddingRight:10}}
